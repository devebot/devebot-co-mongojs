...
var async = Devebot.pkg.async;
var Promise = Devebot.pkg.bluebird;
var lodash = Devebot.pkg.lodash;
var debuglog = Devebot.debug('devebot:co:mongodb:mongodbBridge');
...
var Service = function(params) {
  ...
  self.logger = params.logger || { trace: noop, debug: noop, error: noop };
  ...
  self.mongodb = mongojs(mongo_connection_string, lodash.values(mongo_conf.cols));
  ...
  self.getServiceInfo = function() {
    ...
    return {
      ...
      collection_defs: mongo_conf.cols
    };
  };
