...
var debuglog = debug('devebot:co:mongojs:mongojsBridge');
...
Service.prototype.getCollectionNames = function() {
  var self = this;
  return Promise.promisify(function(callback) {
    self.mongojs.getCollectionNames(function(err, collectionNames) {
...
Service.prototype.countDocuments = function(entity, criteria) {
  ...
  return Promise.promisify(function(callback) {
    self.mongojs[entity].count(criteria, function(err, result) {
      callback(err, result);
    });
  })();
};
...
Service.prototype.findDocuments = function(entity, criteria, start, limit) {
  ...
  return Promise.promisify(function(from, size, callback) {
    self.mongojs[entity].find(criteria).skip(from).limit(size).toArray(function(err, docs) {
      callback(err, docs);
    });
  })(start, limit);
};
...
Service.prototype.findOneDocument = function(entity, criteria) {
  var self = this;
  return Promise.promisify(function(callback) {
    self.mongojs[entity].findOne(criteria, function(err, obj) {
      if (err) {
...
Service.prototype.getOneToManyTargetsBySourceId = function(entityName, sourceIdName, sourceId) {
  ...
  return Promise.promisify(function(callback) {
    ...
    self.mongojs[entityName].find(criteria).toArray(function(err, docs) {
      callback(err, docs);
    });
  })();
};
...
Service.prototype.insertDocument = function(entity, documents) {
  ...
  return Promise.promisify(function (done) {
    self.mongojs[entity].insert(documents, function(err, result) {
      if (err) {
...
Service.prototype.updateDocument = function(entity, criteria, data, options) {
  ...
  var promisee = function (done) {
    self.mongojs[entity].update(criteria, {$set: data}, options, function(err, info) {
      if (err) {
...
Service.prototype.deleteDocument = function(entityName, criteria) {
  var self = this;
  var promisee = function (done) {
    self.mongojs[entityName].remove(criteria, function(err, result) {
      if (err) {
